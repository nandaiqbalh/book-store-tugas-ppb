...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.myViewHolder> {
    ...
    Activity activity;
    ArrayList<Transaction> dataHolder;

    // putString
    Gson gson = new Gson();
    Transaction transaction;

    public HistoryAdapter(Activity activity, ArrayList<Transaction> dataHolder) {
...
//                activity.startActivity(intent);
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            super(itemView);
            gambarBuku = itemView.findViewById(R.id.img_book_history);
            judulBuku = itemView.findViewById(R.id.tv_judul_buku_history);
            penulisBuku = itemView.findViewById(R.id.tv_penulis_buku_history);
            hargaBuku = itemView.findViewById(R.id.tv_harga_buku_history);
            hargaAwalBuku = itemView.findViewById(R.id.tv_harga_awal_history);

            diskonBuku = itemView.findViewById(R.id.tv_diskon_buku_history);
            layoutBuku = itemView.findViewById(R.id.cv_history_book);
        }
    }
}
